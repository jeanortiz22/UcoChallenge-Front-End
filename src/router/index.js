...
import { AUTH0_ROLES_CLAIM, DASHBOARD_REQUIRED_ROLES } from '../constants/authorization';
    ...
    { path: '/register', name: 'register', component: RegisterUserView },
    {
      ...
      beforeEnter: [authGuard, async (to, from, next) => {
        ...
        try {
          ...
          const rolesClaimValue = claims?.[AUTH0_ROLES_CLAIM];
          const roles = Array.isArray(rolesClaimValue)
            ? rolesClaimValue
            : rolesClaimValue
              ? [rolesClaimValue]
              : [];
